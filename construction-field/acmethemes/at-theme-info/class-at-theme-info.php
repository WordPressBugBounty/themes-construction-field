	...
	class Construction_Field_Theme_Info {
		...
		public function get_config() {
			return array(
				...
				'recommended_actions' => array(
					'demo-content' => array(
						'title'       => esc_html__( 'Install Gutentor', 'construction-field' ),
						'desc'        => sprintf( esc_html__( 'Customize everything within default WordPress editor %1$s Gutentor : WordPress Page Builder with Unlimited Possibilities to Design %2$s.', 'construction-field' ), '<a target="_blank" href="https://www.gutentor.com/" >', '</a>' ),
						'id'          => 'gutentor',
		...
		public function at_theme_info_screen() {
			...
			if (
				...
				$notice_nag = get_option( 'construction_field_admin_notice_welcome' );
				if ( ! $notice_nag ) {
					echo '<div class="at-gsm-notice">
                        <small class="plugin-install-notice">' . esc_html__( 'Clicking the button below will install and activate the Advanced Import plugin.', 'construction-field' ) . '</small>
                        <a class="at-gsm-btn button button-primary button-hero" href="#" data-name="" data-slug="" aria-label="' . esc_html__( 'Get started with Construction Field', 'construction-field' ) . '">
                         ' . esc_html__( 'Get started with Construction Field', 'construction-field' ) . '                   
                         </a>
                    </div>';
				}
...
return new Construction_Field_Theme_Info();
